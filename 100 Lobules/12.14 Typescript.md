...
TABLE WITHOUT ID link(file.name, short) AS "Note",   dateformat(file.ctime,"yyyy-MM-dd") AS "Creation date", question AS "Questions"
FROM "200 Neurons"
WHERE contains(file.name, "22.14") and contains(tags, "sets")
FLATTEN substring(file.name, 5) AS short
SORT file.ctime ASC
```
## Maps
...
TABLE WITHOUT ID link(file.name, short) AS "Note",   dateformat(file.ctime,"yyyy-MM-dd") AS "Creation date", question AS "Questions"
FROM "200 Neurons"
WHERE contains(file.name, "22.14") and contains(tags, "maps")
FLATTEN substring(file.name, 5) AS short
SORT file.ctime ASC
```
...
TABLE WITHOUT ID link(file.name, short) AS "Note",   dateformat(file.ctime,"yyyy-MM-dd") AS "Creation date", question AS "Questions"
FROM "200 Neurons"
WHERE contains(file.name, "22.14") and contains(tags, "decorators")
FLATTEN substring(file.name, 5) AS short
SORT file.ctime ASC
```
## Debugging
...
TABLE WITHOUT ID link(file.name, short) AS "Note",   dateformat(file.ctime,"yyyy-MM-dd") AS "Creation date", question AS "Questions"
FROM "200 Neurons"
WHERE contains(file.name, "22.14") and contains(tags, "debugging")
FLATTEN substring(file.name, 5) AS short
SORT file.ctime ASC
```
## DOM
...
TABLE WITHOUT ID link(file.name, short) AS "Note",   dateformat(file.ctime,"yyyy-MM-dd") AS "Creation date", question AS "Questions"
FROM "200 Neurons"
WHERE contains(tags, "javascript") and contains(tags, "dom")  and contains(tags, "typescript")
FLATTEN substring(file.name, 5) AS short
SORT file.ctime ASC
```
